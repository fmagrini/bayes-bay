...
We demonstrate in this tutorial how to use BayesBay to tackle a linear regression problem: polynomial fitting. In the following, we utilise a third-degree polynomial, :math:`y(x) = m_0 + m_1 x + m_2 x^2 + m_3 x^3`, to generate data points :math:`y_1(x_1), y_2(x_2), \ldots, y_n(x_n)`. In matrix notation, these can be expressed as
